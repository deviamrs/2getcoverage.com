...
@section('page_title' , ($post->post_title != null) ? $post->post_title : $post->title)
           ...
           @foreach ($post->postdescriptions as $item)
              ...
              <section id="artica-Box" class="artical-box">
                    ...
                    @if ($item->additional_image != null)
                        ...
                        <img src="{{ asset('public/'.$item->additional_image) }}" alt="{{ $item->description_alt_image != null ? $item->description_alt_image : 'image_not_loaded' }}" style="width: 100%;  margin-bottom:  2rem;" />
                        </div>
                    @endif 
...
@section('custom_Css')
<link rel="stylesheet" href="{{ asset('public/frontAsset/css/owl.carousel.min.css') }}" />
<link rel="stylesheet" href=" {{ asset('public/frontAsset/css/owl.theme.default.css') }}" />
@endsection


    @section('custom_JS')
    <script src=" {{ asset('public/frontAsset/js/jquery.min.js')}}"></script>
   <script src=" {{ asset('public/frontAsset/js/owl.carousel.min.js')}}"></script>
    <script>
