   ...
   <div class="col-lg-12">
     <div class="card mb-4">
       ...
       <div class="table-responsive p-3">
         <table class="table table-sm align-items-center table-flush table-hover mb-5" id="dataTableHover" >
       ...
       @else
         ...
         @if (isset($featured))
            ...
            @include('adminlayout.includes.nodata', ['data' => "Sorry No Featured Post Found" , 'route_name' => 'post'])     

         @elseif(isset($username))
            @include('adminlayout.includes.nodata', ['data' => "Sorry User has not any post yet " , 'route_name' => 'post'])

         @elseif(isset($tagname))

            @include('adminlayout.includes.nodata', ['data' => "Sorry This Tag is not associated With Any Post" , 'route_name' => 'post'])

         @elseif(isset($published))

            @include('adminlayout.includes.nodata', ['data' => "Sorry we dont have  Any published  Post" , 'route_name' => 'post'])
         @elseif(isset($draft))

            @include('adminlayout.includes.nodata', ['data' => "Sorry we dont have  Any Post In Draft" , 'route_name' => 'post'])
          
         @else 
            @include('adminlayout.includes.nodata', ['data' => "Sorry 0 Post Found" , 'route_name' => 'post'])  
          @endif
